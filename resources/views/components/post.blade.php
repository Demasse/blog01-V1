    ...
    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
        ...
        @if ($post->tags->isNotEmpty())
            ...
            <ul class="flex flex-wrap gap-2">
                ...
                <li><a href=" {{route('posts.byTags', ['tag' => $tags ])}} " class="px-3 py-1 bg-indigo-700 text-indigo-50 rounded-full text-sm">{{ $tags->name}}</a> </li>
        ...
        @if ($list)
            ...
            <a href="{{ route('posts.show', ['post' => $post]) }}"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.1251.125V18a2.25 2.25 0 01-2.25 2.25M16.5 7.5V18a2.25 2.25 0 002.25 2.25M16.57.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.250 002.25 2.25h13.5M6 7.5h3v3H6v-3z" />
                </svg>
                Lire l'article
            </a>
